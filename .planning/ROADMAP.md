...
<details>
<summary>✅ v2.0.7 OCM Integration & Container Tooling (Phases 33-37) — SHIPPED 2026-03-21</summary>

Phases 33-37 delivered: OCM token monitor, case data store (sfdc-case.json/case.env), backplane auto-login, container config mount, Claude Code in container, pre-release bug fixes. See milestones/v2.0.7-ROADMAP.md for full details.
