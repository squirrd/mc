...
**Bump version if milestone complete:**

If this is the LAST phase of a milestone:
1. Extract milestone version from ROADMAP.md (e.g., "v2.0.2")
2. Update version in pyproject.toml to match milestone
3. Commit version bump separately:
   ```bash
   git add pyproject.toml
   git commit -m "chore: bump version to {milestone_version}"
   ```
